...
<header>
    ...
    <main>
        <h2>¡Bienvenido a Perú!</h2>
        <p>Perú es un país increíble con una rica herencia cultural y paisajes asombrosos. Explora la belleza de los Andes, la historia de las antiguas civilizaciones y la deliciosa gastronomía peruana.</p>
        <img src="{{ asset('img/peru.jpg') }}" alt="Parque Nacional Natural Tayrona">
    </main>
</body>
</html>